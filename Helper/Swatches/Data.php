...
namespace Imgix\Magento\Helper\Swatches;
...
class Data extends \Magento\Swatches\Helper\Data
{
    ...
    private function getAllSizeImages($imageFile)
    {
        ...
        if (strpos($imageUrl, 'imgix') !== false) {
            ...
            if (!empty($smallImageOptions) && ($smallImageOptions !='') && ($this->imgixHelper->isEnabled())) {
                $smallImageOptions = '?'.$smallImageOptions;
            } else {
                $smallImageOptions = '';
            }

            if (!empty($thumbnailImageOptions) && ($thumbnailImageOptions !='') && ($this->imgixHelper->isEnabled())) {
                $thumbnailImageOptions = '?'.$thumbnailImageOptions;
            } else {
                $thumbnailImageOptions = '';
            }

            $large = $imageUrl.$smallImageOptions;
            $medium = $imageUrl.$smallImageOptions;
            $small = $imageUrl.$thumbnailImageOptions;
        } else {
